...
demonstrateInterval('0:10::5;', 'Five Equally Spaced Points: 0, 2.5, 5, 7.5, 10');
...
demonstrateInterval('1:2:~2;', 'Level 2 Mediants: [[1/1, 2/1], [3/2], [4/3, 5/3]]');
...
demonstrateInterval('1:10:%(5, 1);', 'Random Selection: 5 integers (max denominator 1)');
demonstrateInterval('0:1:%(3, 10);', 'Random Selection: 3 points (max denominator 10)');
...
demonstrateInterval('0:360 :+ 30 ::12;', 'Chained Operations: Step then Divide');
...
console.log('=========================');
console.log('• All interval operators have the same precedence as basic interval (:)');
